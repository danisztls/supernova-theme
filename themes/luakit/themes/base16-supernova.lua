...
local base06 = "#e7f3f4" -- +++
local base07 = "#ffffff" -- ++++
local base08 = "#d40059" -- red
local base09 = "#ff5c00" -- orange
local base0A = "#d9b600" -- yellow
local base0B = "#6bac00" -- green
local base0C = "#00a8e0" -- aqua/cyan
local base0D = "#237ef4" -- blue
local base0E = "#00af9e" -- purple
local base0F = "#ff66c2" -- brown
